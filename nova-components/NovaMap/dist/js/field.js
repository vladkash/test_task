...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-map', __webpack_require__(3));
    Vue.component('detail-nova-map', __webpack_require__(6));
    Vue.component('form-nova-map', __webpack_require__(9));
});
